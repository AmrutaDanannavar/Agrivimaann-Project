...
import img13 from '../Images/home8.jpg';
import img14 from '../Images/home10.jpg';
import img15 from '../Images/home11.jpg';
  ...
  return (
    <div >
      <div  className=' h-64 md:h-auto bg-cover bg-color1 bg-center flex flex-col items-center  '>
        ...
        <img src={images[currentIndex]} className='w-full p-4 h-96 ' />
      ...
      <div className='bg-color1 h-auto  md:h-auto py-10 md:py-10'>
        ...
        <div className='flex flex-col md:flex-row gap-6 md:gap-10 justify-center px-4  '>
          ...
          {/* information2 */}
      <div className="flex flex-row bg-color2 py-10 px-10 h-auto">

        <div className="  w-full md:w-1/2 p-4">
          <h1 className='text-center text-black text-2xl md:text-3xl font-bold mb-4'>We Are Different & Always Professional</h1>
          <img src={img10} className=' rounded-lg  pl-14 w-4/5 h-4/5 rounded' />
        </div>


        <div className=" w-1/2 p-4">
          <div className='flex flex-row flex-wrap pl-4 gap-5 justify-center pt-7  '>

...
import img16 from '../Images/aw2.jpg';
...
const About = () => {
  ...
  return (
    <div>
      ...
      <div className=' flex flex-col md:flex-row bg-color2 p-4 md:p-14 h-auto'>
        <div className='md:w-1/2 mb-6 md:mb-0'>
          <h1 className='text-white text-xl md:text-2xl font-semibold mb-4'>AGRICULTURE</h1>
          <h1 className='text-white text-2xl md:text-3xl font-bold mb-4'>Specializing in Agri Drone Services</h1>
          <p className='text-white text-base md:text-xl mb-4' >Our expertise in drone technology and agriculture enables precision spraying, crop health analysis, and land mapping.</p>
          <span>&#x2705;</span>  <span className='  text-white text-sm pb-2 pl-4'>Precision spraying</span><br/>
          <span>&#x2705;</span> <span className='text-white text-sm pb-2 pl-4'>P Data-driven insights</span><br/>
          <span>&#x2705;</span> <span className='text-white text-sm pb-2 pl-4'>PExpert team of experienced pilots</span> 
        </div>
      ...
      <div className='bg-color4 py-20 h-auto'>
        ...
        <div className=' flex flex-col md:flex-row gap-20  pl-7 md:pl-28 pt-28'>
          {cards.map((card)=>(
            <div className=' relative w-72 h-52 bg-color1'>
